  ...
  profileTab === 'rules' && (
    ...
    <>
      ...
      >
        ...
        >
          Правильно угаданный чемпион турнира — 12 очков
        </div>
        ...
        >
          Прогноз можно менять до начала матча, после начала матча прогноз блокируется.
        </div>

        <div>
          Победителя турнира можно менять до начала первого матча чемпионата.
        </div>
